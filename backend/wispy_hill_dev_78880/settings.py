"""
Django settings for wispy_hill_dev_78880 project.
...
ROOT_URLCONF = 'wispy_hill_dev_78880.urls'
...
WSGI_APPLICATION = 'wispy_hill_dev_78880.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "wispy_hill_dev_78880 API",
    "DESCRIPTION": "API documentation for wispy_hill_dev_78880 App",
    "VERSION": "v1",
}
